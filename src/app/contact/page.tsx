...
export default function Contact() {
  const [state, handleSubmit] = useForm(process.env.FORMSPREE_ENDPOINT as string);
  console.log("FORMSPREE_ENDPOINT:", process.env.FORMSPREE_ENDPOINT);
     if (state.succeeded) {
         return (
           alert(
             <div>
        ...
        <div>
            ...
            <div className="flex flex-col min-h-screen align-middle justify-between items-center">
                <div className="lg:w-1/3 w-1/2">
                    <h1 className="text-xl uppercase text-cyan-700 text-center pt-20">
                        Contact Me
                    </h1>
                ...
                <div className="flex justify-center gap-20 text-teal-900 mb-20">
                    <a
